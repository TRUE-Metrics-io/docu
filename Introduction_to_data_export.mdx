...
### AWS
For customers using AWS as their cloud provider, the setup is straightforward. Simply configure an S3 bucket, and we will automatically update it daily with the latest data using AWS DataSync.
