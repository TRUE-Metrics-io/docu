...
Android SDK can run on minimum Android 7.0 (API level 24). Project requires Java 17. If necessary, adjust your Java version in your IDE, typically in `IDE's File -> Project structure -> SDK Location`.
