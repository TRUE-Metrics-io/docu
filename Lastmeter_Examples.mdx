...
`https://api.truemetrics.cloud` and `YOUR_API_KEY` as placeholders, and `…ADDRESS_ID` placeholders
...
curl --location 'https://api.truemetrics.cloud/lastmetervisualization?identifier_entrance=ADDRESS_ID&identifier_parking=ADDRESS_ID' \
...
<RequestExample>
```bash Example Request
curl --location 'https://api.truemetrics.cloud/lastmetervisualization?identifier_entrance=ENTRANCE_ADDRESS_ID&identifier_parking=PARKING_ADDRESS_ID' \
--header 'x-api-key: YOUR_API_KEY'
```
</RequestExample>
...
<RequestExample>
```bash Example Request
curl --location 'https://api.truemetrics.cloud/lastmetervisualization?identifier_entrance=ADDRESS_ID&identifier_parking=ADDRESS_ID&raster=true' \
--header 'x-api-key: YOUR_API_KEY'
```
</RequestExample>
...
<RequestExample>
```bash Example Request
curl --location 'https://api.truemetrics.cloud/lastmetervisualization?identifier_entrance=ADDRESS_ID&identifier_parking=ADDRESS_ID&raster=true&basemap=true' \
--header 'x-api-key: YOUR_API_KEY'
```
</RequestExample>
...
curl -s --header 'x-api-key: YOUR_API_KEY' \
  'https://api.truemetrics.cloud/lastmetervisualization?identifier_entrance=ADDRESS_ID&identifier_parking=ADDRESS_ID&raster=true&basemap=true' \
