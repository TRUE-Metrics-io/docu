---
title: 'SDK Interface'
description: 'Overview of the functionality of the Truemetrics Android SDK 1.6.3'
---
...
| NOT_INITIALIZED | `startRecording()` was called before `init()` or after `deinitialize()`, so there is nothing to record with |
